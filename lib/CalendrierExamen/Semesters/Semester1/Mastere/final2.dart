...
class ExamSchedulePageFinal2 extends StatefulWidget {
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  
   final String masterId; // Ajouter un argument pour l'identifiant de la maîtrise

  ExamSchedulePageFinal2({Key? key, required this.masterId}) : super(key: key);
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  @override
  _ExamSchedulePageFinal2State createState() => _ExamSchedulePageFinal2State();
}

class _ExamSchedulePageFinal2State extends State<ExamSchedulePageFinal2> {
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                _db..collection('masters')
        .doc(widget.masterId).collection('exams').add({
                  'subject': subject,
                  'time': time,
                  'day': day,
                  'group': group,
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                _db
                    .collection('masters')
        .doc(widget.masterId)..collection('exams')
                  ...
                  _db..collection('masters')
        .doc(widget.masterId).collection('exams').doc(docId).update({
                    'subject': newSubject,
                  });
                });
              },
...
//////////
  ...
  void _deleteExam(String time, String day) {
    ...
    _db
      ...
      final docId = querySnapshot.docs.first.id;
      _db.collection('masters')
        .doc(widget.masterId).collection('exams').doc(docId).delete();
    });
  }
...
/////////////////////////changement////////////////////////////////////////////////////////////////////////////////////
  ...
  void initState() {
    ...
    _db.collection('masters')
        .doc(widget.masterId).collection('exams').get().then((snapshot) {
